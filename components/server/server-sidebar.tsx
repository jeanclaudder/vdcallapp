...
import {  MessageSquareIcon, Mic, ShieldAlert, ShieldCheck, Video } from "lucide-react";
...
const iconMap={
    [ChannelType.TEXT]:<MessageSquareIcon className="mr-2 h-4 w-4 "/>,
    [ChannelType.AUDIO]:<Mic className="mr-2 h-4 w-4 "/>,
    [ChannelType.VIDEO]:<Video className="mr-2 h-4 w-4 "/>
};
const roleIconMap ={
    [MemberRole.GUEST]:null,
    [MemberRole.MODDERATOR]:<ShieldCheck className="h-4 w-4 mr-2 text-indigo-500"/>,
